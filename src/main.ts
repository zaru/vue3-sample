...
import DeepNestProvideInjectTypedPage from './pages/deep_nest/ProvideInjectTypedPage.vue';
...
const routes = [
  ...
  { path: '/deep_nest/provide_inject_typed', component: DeepNestProvideInjectTypedPage },
];
